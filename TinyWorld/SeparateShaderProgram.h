...
#define SEPARATE_SHADER_PROGRAM_CAST(p_shader_program)\
    ...
    protected:
        ...
        SeparateShaderProgram_Core& operator=(const SeparateShaderProgram_Core& other) = default;
        SeparateShaderProgram_Core& operator=(SeparateShaderProgram_Core&& other) = default;
    ...
    public:
        ...
        SeparateShaderProgram& operator=(const SeparateShaderProgram& other) = default;
        SeparateShaderProgram& operator=(SeparateShaderProgram&& other) = default;
