...
namespace tiny_world
{
    ...
    protected:
        ...
        AbstractRenderableObjectExtensionAggregator& operator=(const AbstractRenderableObjectExtensionAggregator&) = default;
        AbstractRenderableObjectExtensionAggregator& operator=(AbstractRenderableObjectExtensionAggregator&&) = default;
